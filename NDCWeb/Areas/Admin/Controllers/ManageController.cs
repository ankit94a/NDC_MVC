...
namespace NDCWeb.Areas.Admin.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            ChangePasswordViewModel msm = new ChangePasswordViewModel();
        ...
        #endregion
        #region Transfer Course Member to Alumni
        public ActionResult CourseToAlumni()
        {
            return View();
        }

        [HttpPost]
        public ActionResult CourseToAlumni(string CourseNo)
        {
            ViewBag.Error = "";
            string cnnString = System.Configuration.ConfigurationManager.ConnectionStrings["NDCWebConString"].ConnectionString;

            SqlConnection cnn = new SqlConnection(cnnString);
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = cnn;
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.CommandText = "ConvertCourseParticipentsAsAlumni";
